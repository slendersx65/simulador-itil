"""
Django settings for tesis_simulador project.
...
ALLOWED_HOSTS = ['simulador-ITIL.com', '127.0.0.1']
...
WSGI_APPLICATION = 'tesis_simulador.wsgi.application'
